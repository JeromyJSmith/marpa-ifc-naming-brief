...
- MARPA financial engine;
- Pixeltable `budget.*` style evidence;
- DuckDB/DuckLake serving snapshots;
- Pydantic contracts;
- Marimo modeling surfaces;
- CSI and project-cost taxonomies.
